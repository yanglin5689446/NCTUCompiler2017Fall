...
constants: constant constants  | epsilon ;
constant: CONSTANT_INT  | CONSTANT_REAL  | CONSTANT_STRING  | TRUE  | FALSE ;

/* declaration */
var_declars: var_declar var_declars | epsilon ;
var_declar: VAR identifiers ':' declar_type ';';
declar_type: constants | type  | ARRAY CONSTANT_INT TO CONSTANT_INT OF declar_type;   /* var & array */
...
flow: if | while | for;
if: IF expr THEN statements if_ _END IF;
if_: ELSE statements | epsilon;
